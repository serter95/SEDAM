		...
		<article class="contenido">
			<article id="pantalla">
			  <article class="informacion">
					...
					<p class="p">SUMA Y RESTA DE DECIMALES<br><br> PARA SUMAR Y RESTAR N&Uacute;MEROS DECIMALES DEBEMOS SEGUIR EL MISMO PROCEDIMIENTO 		 								QUE UTILIZAMOS PARA SUMAR O RESTAR N&Uacute;MEROS NATURALES, SÓLO QUE DEBEMOS ALINEAR LAS COMAS DE LOS SUMANDOS.
								<br> <br>
					...
					<article class="dialogo" id="ejemplo">
					<img src="../img/sumadecimal.jpg" width="320px" height="100px" alt="description" />
					<img src="../img/restadecimal.jpg" width="320px" height="100px" alt="description" />
					</article>
					
				 	 <form action="videosuresdecimal.php" method="post">
