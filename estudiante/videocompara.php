		...
		<article class="contenido">
			<article>
				...
				<video controls width="600" height="400" class="video">
					<source src="../img/comparacion.ogv" type="video/ogg">
				</video>
			
			</article>
			<form action="operaciones.php" method="post">
						<input type="hidden" value="comparacion" name="operador" />
			...
			<form action="tcomparacion.php" method="post">
						<input type="hidden" value="suma" name="operador" />
						<button type="submit" name="enviar" class="eteoria">
						<img src="../img/flechac.png" width="width" height="height" alt="description"  class="flechac"/>
						</button>
					</form>
		</article>
		</section>
