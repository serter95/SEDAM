		...
		<article class="contenido">
			<section id="conocenos1" >
				...
				<table width="600px" >
					<tr>
						<td align="justify">
						Garantizar una educaci&oacute;n demotratica, participativa, protagonica, multitecnica y pluricultural que permita formar integramente a niñas, noños y adolecentes sin ningun tipo de discriminaci&oacute;
						rescatando el ideario bolivariano en función de reivindicar el papel de la Naci&oacute;n que se reconoce en su historia, para asumir los retos del momento.
					</td>
					</tr>
					<tr>
						<td align="right">
