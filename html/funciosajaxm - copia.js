...
$(function(){
	...
	$('#modificar').on('click',function(){
		$('#form1').dialog('open');//ABRIMOS EL FORMULARIO COMO TIPO DIALOG
...
$(function(){
	...
	$('#siguiente').on('click',function(){
		$('#form1').dialog('close');//ABRIMOS EL FORMULARIO COMO TIPO DIALOG
		//$('#formt input[type=text]').val('');//BORRAMOS TODOS LOS CAMPOS TIPO TEXT EN EL FORM
		//$('#status_user option[selected]').removeAttr('selected');//REMOVEMOS EL ATTRIBUTO SELECTED DEL SELECT
		//$("#opcion").val("nuevo");
	});
	...
	$('#siguiente').on('click',function(){
		$('#form2').dialog('open');//ABRIMOS EL FORMULARIO COMO TIPO DIALOG
		//$('#formt input[type=text]').val('');//BORRAMOS TODOS LOS CAMPOS TIPO TEXT EN EL FORM
		//$('#status_user option[selected]').removeAttr('selected');//REMOVEMOS EL ATTRIBUTO SELECTED DEL SELECT
		//$("#opcion").val("nuevo");
	});
		...
		$('#form2').dialog('close');//ABRIMOS EL FORMULARIO COMO TIPO DIALOG
		//$('#formt input[type=text]').val('');//BORRAMOS TODOS LOS CAMPOS TIPO TEXT EN EL FORM
		//$('#status_user option[selected]').removeAttr('selected');//REMOVEMOS EL ATTRIBUTO SELECTED DEL SELECT
		//$("#opcion").val("nuevo");
	});
