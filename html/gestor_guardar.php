...
//Comparacion de los formatos;
		...
		header('Location: alert.php');
			...
			if(!in_array($nombreArchivo6, $file_array))
				...
				$sql_cp = "select ci_profesor from profesor where nom_usuario='$nom'";
...
$planificacion = $_REQUEST['planificacion'];
$objetivo = $_REQUEST['objetivo'];
$titulo = $_REQUEST['titulo'];
$contenido = $_REQUEST['contenido'];
$descripcion = $_REQUEST['descripcion'];

$sql="INSERT into tema (codig_tema, fecha_creacion, momento, planificacion, objetivo, titulo, contenido, descripcion, ejemplo1, ejemplo2, ejemplo3, ejemplo4, video1, video2, ci_profesor, ano) values ('$codigo','$fecha_creacion','$momento','$planificacion','$objetivo','$titulo','$contenido','$descripcion','$rnombreArchivo1','$rnombreArchivo2','$rnombreArchivo3','$rnombreArchivo4','$rnombreArchivo5','$rnombreArchivo6', '$ci_cp', '$ano')";
mysql_query($sql);			
				?>  
...
$aud="INSERT INTO auditoria (nom_usuario, accion, fecha, hora)values('".$_SESSION['nom_usuario']."','Insercion de Tema','$fecha','$hora')";
...
//El else que reacciona si no esta el segundo video
				...
				$sql="INSERT INTO tema(codig_tema,fecha_creacion,momento,planificacion,objetivo,titulo,contenido,descripcion,ejemplo1,ejemplo2,ejemplo3,ejemplo4,video1, ci_profesor, ano)values('$codigo','".$_REQUEST['fecha_creacion']."','".$_REQUEST['momento']."','".$_REQUEST['planificacion']."','".$_REQUEST['objetivo']."','".$_REQUEST['titulo']."','".$_REQUEST['contenido']."','".$_REQUEST['descripcion']."','$rnombreArchivo1','$rnombreArchivo2','$rnombreArchivo3','$rnombreArchivo4','$rnombreArchivo5', '$ci_cp', '$ano')";
				mysql_query($sql);

				?>  
							<script language="javascript">
								alert("Se guardo con \u00e9xito 2");
								location.href="indice_teoria.php"; 
							</script> 
						<?php 
