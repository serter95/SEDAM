...
<body>
	...
	<form action="editar_usuario.php" method="get" onsubmit="return validacion_mod()">
	...
	<tr>
		...
		<td> <label><b><lettab>Contrase&ntilde;a:</lettab></b></label></br>
			<input type="text" value="<?php echo $_REQUEST['contrasena']?>" disabled title="contrase&ntilde;a actual del usuario"/>
		</td>

		<td><label><b><lettab>Nivel:</lettab></b></label></br>
			<input type="text" value="<?php echo $_REQUEST['nivel']?>" disabled title="Nivel del usuario" />
		</td>
	</tr>
	
	<tr>
		<td> <label><b><lettab>Due&ntilde;o:</lettab></b></label></br>
			<input type="text" value="<?php echo $_REQUEST['dueno']?>" disabled title="Tipo de due&ntilde;o del usuario"/>
		</td>
		
		<td> <label><b><lettab>Nueva Contrase&ntilde;a:</lettab></b></label></br>
			<ast>*</ast><input type="password" name="nueva_contrasena" id="contrasena" maxlength="30" placeholder="Ej:1234" title="Ingrese la nueva contrase&ntilde;a del usuario"/>
		</td>

		<td> <label><b><lettab>Repita nueva Contrase&ntilde;a:</lettab></b></label></br>
			<ast>*</ast><input type="password" name="rep_nueva_contrasena" id="rep_contrasena" maxlength="30" placeholder="Ej:1234" title="Repita la nueva contrase&ntilde;a del usuario"/>
		</td>
	</tr>
	</table>
	</br>
	...
	<tr>
		...
		<a href="consult_usuario.php" title="hacer click para cancelar la modificaci&oacute;n"><img height="32px" width="32px" src="../img/cancelar.png"></a>
		</article>
		</td>
	</tr>
	</table>
