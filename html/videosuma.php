			...
			<article>
				...
				<video controls width="600" height="400" class="video">
					<source src="../img/suma.ogv" type="video/ogg">
						<!--<object width="500" height="400" data="../img/suma.ogv">
							<param name="movie" value="../img/suma.ogv" />
							<embed src="../img/suma.ogv" width="500" height="400">
							</embed>
						</object>-->
				</video>
				...
				<form action="tsuma.php" method="post">
