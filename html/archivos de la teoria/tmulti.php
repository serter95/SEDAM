			...
			<article class="contenido">
				<article id="pantalla">
				  <article class="informacion">
						...
						<p class="p">MULTIPLICACI&Oacute;N<br><br> LA MULTIPLICACI&Oacute;N CONSISTE EN HALLAR EL RESULTADO DE SUMAR UN NÚMERO TANTAS 			 						VECES COMO INDIQUE OTRO. <br> 1 X 2 = 2<br> <br> 1 Y 2 TAMBIÉN SE LE LLAMA MULTIPLICANDO Y SON LOS NÚMEROS QUE SE MULTIPLICAN.
						<br> <br> PARA SU NOTACI&Oacute;N SE EMPLEA ES EL SIGNO * QUE SE LEE "POR".</p>
						
						<article id="ejemplo" class="edialogo">
							<center>
								<img src="../img/multiplicacion.png" width="300px" height="130px" /><br>
								<img src="../img/multiplicacion2.png"  width="210px" height="200px" />
								<img src="../img/multiplicacion3.png"  width="210px" height="200px" />
							</center>
						</article>
						
						<img src="../img/profeec.png" class="profe" />
					   <form action="videomulti.php" method="post">
